...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Feb 26 19:32:25 2015
...
SOURCES       = main.cpp \
		...
		commandcreator.cpp \
		iomanager.cpp \
		statusmonitor.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		BlackADC.o \
		BlackCore.o \
