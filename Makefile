...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Feb 17 11:03:04 2015
...
SOURCES       = main.cpp \
		...
		bb_uart.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		BlackADC.o \
		BlackCore.o \
...
$(TARGET): ui_mainwindow.h ui_tutorial.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/GARVIS_CM1.0.0/ && $(COPY_FILE) --parents mainwindow.h BlackLib/v2_0/BlackADC.h BlackLib/v2_0/BlackCore.h BlackLib/v2_0/BlackDef.h BlackLib/v2_0/BlackErr.h BlackLib/v2_0/BlackGPIO.h BlackLib/v2_0/BlackI2C.h BlackLib/v2_0/BlackLib.h BlackLib/v2_0/BlackPWM.h BlackLib/v2_0/BlackSPI.h BlackLib/v2_0/BlackUART.h bb_uart.h .tmp/GARVIS_CM1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp BlackLib/v2_0/BlackADC.cpp BlackLib/v2_0/BlackCore.cpp BlackLib/v2_0/BlackGPIO.cpp BlackLib/v2_0/BlackI2C.cpp BlackLib/v2_0/BlackPWM.cpp BlackLib/v2_0/BlackSPI.cpp BlackLib/v2_0/BlackUART.cpp bb_uart.cpp .tmp/GARVIS_CM1.0.0/ && $(COPY_FILE) --parents mainwindow.ui tutorial.ui .tmp/GARVIS_CM1.0.0/ && (cd `dirname .tmp/GARVIS_CM1.0.0` && $(TAR) GARVIS_CM1.0.0.tar GARVIS_CM1.0.0 && $(COMPRESS) GARVIS_CM1.0.0.tar) && $(MOVE) `dirname .tmp/GARVIS_CM1.0.0`/GARVIS_CM1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/GARVIS_CM1.0.0
...
compiler_uic_make_all: ui_mainwindow.h ui_tutorial.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_tutorial.h
ui_mainwindow.h: mainwindow.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic mainwindow.ui -o ui_mainwindow.h

ui_tutorial.h: tutorial.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic tutorial.ui -o ui_tutorial.h
