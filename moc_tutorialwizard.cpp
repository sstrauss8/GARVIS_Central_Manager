/****************************************************************************
** Meta object code from reading C++ file 'tutorialwizard.h'
**
...
#error "The header file 'tutorialwizard.h' doesn't include <QObject>."
...
static const uint qt_meta_data_TutorialWizard[] = {
...
static const char qt_meta_stringdata_TutorialWizard[] = {
    "TutorialWizard\0\0showHelp()\0"
};

void TutorialWizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        TutorialWizard *_t = static_cast<TutorialWizard *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData TutorialWizard::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TutorialWizard::staticMetaObject = {
    { &QWizard::staticMetaObject, qt_meta_stringdata_TutorialWizard,
      qt_meta_data_TutorialWizard, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TutorialWizard::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *TutorialWizard::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *TutorialWizard::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TutorialWizard))
        return static_cast<void*>(const_cast< TutorialWizard*>(this));
    return QWizard::qt_metacast(_clname);
}

int TutorialWizard::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
